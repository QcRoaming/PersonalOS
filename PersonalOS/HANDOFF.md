...
|---|---|---|---|---|
| `skills.mcp` | 2026-07-18T16:37:53Z | 完成 PersonalOS 项目文档整理：仓库首页、详细手册与 START_HERE 已对齐 v2.1 当前能力、事实源边界、首跑环境变量、PowerShell、Lane version 冲突保护和只读网页连接器限制。 | 在真实文本窗口和语音窗口验证导入触发、会话选择、触发点截断与覆盖级别。 | 重启 Codex CLI 或 VS Code Codex 扩展，并在真实文本/语音窗口、第二账号和第二设备完成端到端验收。 |
