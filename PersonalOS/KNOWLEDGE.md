...
| `research.kernel_aware_gemm` | search economics | verified | i7 posthoc point/LCB95 break-even is 165865/741587 synthetic equal-frequency cycles with explicit Cc/sum-Cs decomposition; i9 and K230 exact-shape generated paths have no finite positive-cost break-even | validate only when a future generated path first beats the complete-library baseline |
